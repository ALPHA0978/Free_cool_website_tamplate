 ...
 * 
 * Interactive SVG visualization showing data flow through REST API endpoints.
 * Features animated paths, glowing effects, and pulsing circles.
 * 
 * Features:
 * - Animated SVG paths showing data flow
 * - REST API method badges (GET, POST, PUT, DELETE)
 * - Glowing light effects following the paths
 ...
 * @param {string} circleText - Text displayed in bottom circle
 * @param {Object} badgeTexts - Custom text for API method badges
 * @param {Object} buttonTexts - Custom text for action buttons
 * @param {string} title - Main title text
 * @param {string} lightColor - Custom color for glowing effects
 * 
 * @example
 * <DatabaseWithRestApi 
 ...
 *   circleText="API"
 *   lightColor="#00A6F5"
 *   badgeTexts={{ first: "GET", second: "POST" }}
 * />
 */
        ...
        <g stroke="currentColor" fill="none" strokeWidth="0.4">
          ...
          <g>
            <rect
              ...
              rx="5"
            ></rect>
            <DatabaseIcon x="18" y="7.5" color={textColor}></DatabaseIcon>
            <text
              x="28"
              y="12"
              fill={textColor}
          ...
          <g>
            <rect
              ...
              rx="5"
            ></rect>
            <DatabaseIcon x="64" y="7.5" color={textColor}></DatabaseIcon>
            <text
              x="74"
              y="12"
              fill={textColor}
          ...
          <g>
            <rect
              ...
              rx="5"
            ></rect>
            <DatabaseIcon x="112" y="7.5" color={textColor}></DatabaseIcon>
            <text
              x="122"
              y="12"
              fill={textColor}
          ...
          <g>
            <rect
              ...
              rx="5"
            ></rect>
            <DatabaseIcon x="154" y="7.5" color={textColor}></DatabaseIcon>
            <text
              x="165"
              y="12"
              fill={textColor}
...
const DatabaseIcon = ({ x = "0", y = "0", color = "#000000" }) => {
  return (
    <svg
      x={x}
      y={y}
